...
st.set_page_config(page_title='競馬ランクアプリ v13.3 Standard Bet Below', layout='centered')
...
# UI
# =========================
st.title('競馬ランクアプリ v13.3 Standard Bet Below')
st.write('◎推奨馬ロジックは維持し、○▲は従来の上位評価寄り、△だけ「2着残り専用枠」に変更した完全版です。')
st.caption('v13.3: SNS画像の馬名被りを防ぐため、標準型の買い目を相手表示の下段に表示します。馬連は◎-○▲△、ワイドは◎-○△。')
