...
st.set_page_config(page_title="競馬ランクアプリ v10.1 Smart Axis", layout="centered")
...
st.title("競馬ランクアプリ v10.1 Smart Axis")
st.write("4月の9R・11R実戦を踏まえ、比重見直しに加えて軸馬選定も改良した版です。連系は条件を満たした時だけ出し、馬連は改良軸→相手3頭、三連複は改良軸→相手3頭流しです。")
