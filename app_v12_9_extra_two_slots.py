...
st.set_page_config(page_title='競馬ランクアプリ v12.9 Extra Two Slots', layout='centered')
...
# UI
# =========================
st.title('競馬ランクアプリ v12.9 Extra Two Slots')
st.write('◎推奨馬ロジックは維持し、○▲は従来の上位評価寄り、△だけ「2着残り専用枠」に変更した完全版です。')
st.caption('v12.9: △は2着残り専用枠。さらに三連複3列目用に「能力残し枠」「位置取り・展開残り枠」の他2頭を追加します。')
