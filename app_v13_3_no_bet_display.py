...
st.set_page_config(page_title='競馬ランクアプリ v13.3 No Bet Display', layout='centered')
...
# UI
# =========================
st.title('競馬ランクアプリ v13.3 No Bet Display')
st.write('◎推奨馬ロジックは維持し、○▲は従来の上位評価寄り、△だけ「2着残り専用枠」に変更した完全版です。')
st.caption('v13.3: ◎/○▲△/他1・他2の表示を維持。SNS画像には買い目を表示しません。')
