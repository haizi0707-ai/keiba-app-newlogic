...
st.set_page_config(page_title='競馬ランクアプリ v12.8 Second Place Slot', layout='centered')
...
# UI
# =========================
st.title('競馬ランクアプリ v12.8 Second Place Slot')
st.write('◎推奨馬ロジックは維持し、○▲は従来の上位評価寄り、△だけ「2着残り専用枠」に変更した完全版です。')
st.caption('v12.8: 前走4角位置・内枠・距離短縮/延長・コース別の残り方を使い、馬連の3頭目で2着残りを拾います。')
